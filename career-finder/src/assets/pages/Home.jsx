       ...
       <div className='mx-16 '>
        ...
        <section className='flex flex-col items-center justify-center text-center px-6 py-24 min-h-[85vh] '>
          ...
          <button
            ...
            className='group flex items-center mt-3 px-6 py-3 bg-[#A1D800] border-3
        ...
        <section className='flex flex-col md:flex-row min-h-[80vh] mt-30 md:mt-5'>
          ...
          <div className='w-full md:w-1/3  flex flex-col justify-center px-8 md:px-10 py-12 md:py-18'>
            ...
            <h2 className='text-3xl md:text-5xl  text-[#A1D800] font-judson font-bold -mt-38'>
            The <br/> Problem
            </h2>
        ...
        {/* Right-side */}
         <div className=' grainy w-full md:w-2/3 flex flex-col justify-center px-8 md:px-12 py-20 md:py-20  bg-[#DFFDBA] '>
        ...
        <p className='relative z-10 px-15 py-10 text-3xl leading-relaxed text-center' >
