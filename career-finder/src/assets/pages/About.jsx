...
{/* OUR MISSION */}
  <section className='min-h-[80vh] '>
    <div className='flex flex-col md:flex-row min-h-[80vh]'>
      ...
      <h1 className='text-bold text-5xl md:text-7xl p-8'>
      ...
      <div className=' hidden md:block w-2 bg-white my-10 '>

      </div>


     <p className='text-white text-xl md:text-4xl flex justify-center items-center text-center p-10 tracking-wide leading-relaxed'>
...
<section className='grainy min-h-[80vh] bg-bg_green'>
  <div className='flex flex-col md:flex-row w-full min-h-[80vh]'>
    ...
    <div className=' relative w-full md:w-2/3 flex flex-col items-center justify-center '>
      <p className='text-black z-10 text-xl md:text-4xl p-5 mt-15 text-center tracking-wide leading-relaxed'>
    ...
    {/* line */}
    <div className=' relative hidden md:block w-1 bg-black my-5'> </div>
...
<div className='flex flex-col md:flex-row w-full min-h-[80vh]'>
  ...
  <h1 className=' p-8'>
    <span className='font-bold font-judson text-5xl md:text-7xl text-white'>OUR</span><br/>
    <span className='font-luckiest-guy text-5xl md:text-7xl  text-blue-700'>SOlUTION</span>
  </h1>
  <img src={sport} alt='image' 
  className='w-60 md:w-80 ml-5 '>
  </img>
</div>
{/* line */}
<div className='bg-white hidden md:block w-1 my-10'>

</div>
{/* Para */}
<div className='flex flex-col justify-center items-center p-5'>
  <p className='text-xl md:text-4xl text-white text-center leading-relaxed tracking-wide  '>
